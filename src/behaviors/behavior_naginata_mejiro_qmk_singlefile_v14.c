...
static inline void tap_key(uint32_t keycode) {
    int64_t ts_press = timestamp;
    int64_t ts_release = timestamp + 1;
...
static const mj_cmd_t mejiro_commands_zmk[] = {
    ...
    {"#-t",     MJ_CMD_KEY,      MJ_KC(HID_USAGE_KEY_KEYBOARD_INTERNATIONAL1), 0, 0, NULL},
    {"#-k",     MJ_CMD_KEY,      MJ_KC(HID_USAGE_KEY_KEYBOARD_INTERNATIONAL2), 0, 0, NULL},
