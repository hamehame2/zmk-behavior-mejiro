...
/* --------------------------------------------------------------------------
 * HID "stuck key" mitigation
 * -------------------------------------------------------------------------- */
__attribute__((weak)) void zmk_hid_keyboard_release_all(void) {}
__attribute__((weak)) void zmk_hid_keyboard_clear(void) {}

static inline void ng_hid_unstick(void) {
    /* Either/both may be implemented depending on ZMK version/config. */
...
static int on_keymap_binding_pressed(struct zmk_behavior_binding *binding,
    ...
    if (!naginata_press(binding, event)) {
        /* Not handled by Naginata logic: pass through as a normal key. */
        tap_key(binding->param1);
    }
...
static int on_keymap_binding_released(struct zmk_behavior_binding *binding,
    ...
    (void)naginata_release(binding, event);
