...
static naginata_kanamap ngdickana[] = {
    ...
    {.shift = NONE    , .douji = B_R            , .kana = {COMMA, NONE, NONE, NONE, NONE, NONE}, .func = nofunc }, // 、変換yameta
    ...
    {.shift = NONE    , .douji = B_DOT          , .kana = {DOT, NONE, NONE, NONE, NONE, NONE   }, .func = nofunc }, // 。変換yameta
