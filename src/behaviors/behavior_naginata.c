/* Generated variant for staged Mejiro debugging on 2026-03-07. */
/*
...
static const verb_entry_t verb_dict[] = {
    {"A-STU", "ある", 'k', VERB_TYPE_GODAN},
    {"I-TNA", "いただ", 'k', VERB_TYPE_GODAN},
    {"U-KNAU", "うご", 'k', VERB_TYPE_GODAN},
    {"KA-YA", "かがや", 'k', VERB_TYPE_GODAN},
    {"KI-TU", "きがつ", 'k', VERB_TYPE_GODAN},
    {"KI-TNU", "きづ", 'k', VERB_TYPE_GODAN},
    {"SI-KNAU", "しご", 'k', VERB_TYPE_GODAN},
    {"TA-TA", "たたか", 'w', VERB_TYPE_GODAN},
    {"TN-KU", "つづ", 'k', VERB_TYPE_GODAN},
    {"NAU-SNAU", "のぞ", 'm', VERB_TYPE_GODAN},
    {"TKA-STA", "はら", 'w', VERB_TYPE_GODAN},
    {"SKNI-KNA", "みが", 'k', VERB_TYPE_GODAN},
    {"I-SAU", "いそ", 'g', VERB_TYPE_GODAN},
    {"KA-SIA", "かせ", 'g', VERB_TYPE_GODAN},
    {"KA-TU", "かつ", 'g', VERB_TYPE_GODAN},
    {"SA-SA", "ささ", 'w', VERB_TYPE_SIMO},
    {"SA-SKA", "さわ", 'g', VERB_TYPE_GODAN},
    {"TU-NA", "つな", 'g', VERB_TYPE_GODAN},
    {"TKU-SA", "ふさ", 'g', VERB_TYPE_GODAN},
    {"TKU-SIA", "ふせ", 'g', VERB_TYPE_GODAN},
    {"A-KA", "あか", 's', VERB_TYPE_GODAN},
    {"I-KA", "いか", 's', VERB_TYPE_GODAN},
    {"I-TA", "いた", 's', VERB_TYPE_GODAN},
    {"AU-TAU", "おと", 's', VERB_TYPE_GODAN},
    {"KA-KA", "かか", 's', VERB_TYPE_GODAN},
    {"KA-KU", "かく", 's', VERB_TYPE_GODAN},
    {"KU-STA", "くら", 'b', VERB_TYPE_SIMO},
    {"KAU-STAU", "ころ", 's', VERB_TYPE_GODAN},
    {"KAU-SKA", "こわ", 's', VERB_TYPE_GODAN},
    {"TA-AU", "たお", 's', VERB_TYPE_GODAN},
    {"TU-TKNU", "つぶ", 's', VERB_TYPE_GODAN},
    {"TIA-STA", "てら", 'w', VERB_TYPE_GODAN},
    {"NA-AU", "なお", 's', VERB_TYPE_GODAN},
    {"NI-KNA", "にが", 's', VERB_TYPE_GODAN},
    {"NAU-KAU", "のこ", 's', VERB_TYPE_GODAN},
    {"NAU-TKNA", "のば", 's', VERB_TYPE_GODAN},
    {"TKA-NA", "はな", 's', VERB_TYPE_GODAN},
    {"SKNA-KA", "まか", 's', VERB_TYPE_SIMO},
    {"SKNI-NA", "みな", 's', VERB_TYPE_GODAN},
    {"YU-STA", "ゆら", 's', VERB_TYPE_GODAN},
    {"SKA-TA", "わた", 's', VERB_TYPE_GODAN},
    {"U-KNA", "うたが", 'w', VERB_TYPE_GODAN},
    {"SAU-TNA", "そだ", 't', VERB_TYPE_GODAN},
    {"TA-SKNAU", "たも", 't', VERB_TYPE_GODAN},
    {"SKNIA-TNA", "めだ", 't', VERB_TYPE_GODAN},
    {"A-SAU", "あらそ", 'w', VERB_TYPE_GODAN},
    {"IA-STA", "えら", 'b', VERB_TYPE_GODAN},
    {"AU-YAU", "およ", 'b', VERB_TYPE_GODAN},
    {"NA-STA", "なら", 'w', VERB_TYPE_GODAN},
    {"TKA-KAU", "はこ", 'b', VERB_TYPE_GODAN},
    {"TKAU-STAU", "ほろ", 'b', VERB_TYPE_GODAN},
    {"SKNA-NA", "まな", 'b', VERB_TYPE_GODAN},
    {"SKNU-SU", "むす", 'b', VERB_TYPE_GODAN},
    {"YAU-STAU", "よろこ", 'b', VERB_TYPE_GODAN},
    {"I-NA", "いな", 'm', VERB_TYPE_GODAN},
    {"U-STA", "うらや", 'm', VERB_TYPE_GODAN},
    {"KA-KNA", "かんが", 'w', VERB_TYPE_SIMO},
    {"KA-SU", "かす", 'm', VERB_TYPE_GODAN},
    {"SU-SU", "すす", 'm', VERB_TYPE_GODAN},
    {"TA-NAU", "たの", 'm', VERB_TYPE_GODAN},
    {"TIU-TKNA", "ついば", 'm', VERB_TYPE_GODAN},
    {"TU-TU", "つつ", 'm', VERB_TYPE_GODAN},
    {"TU-SKNA", "つま", 'm', VERB_TYPE_GODAN},
    {"NA-YA", "なや", 'm', VERB_TYPE_GODAN},
    {"NU-SU", "ぬす", 'm', VERB_TYPE_GODAN},
    {"NAU-SNAU", "のぞ", 'm', VERB_TYPE_GODAN},
    {"TKA-SA", "はさ", 'm', VERB_TYPE_GODAN},
    {"TKA-STA", "はら", 'w', VERB_TYPE_GODAN},
    {"TKI-KAU", "ひっこ", 'm', VERB_TYPE_GODAN},
    {"TKU-KU", "ふく", 'm', VERB_TYPE_GODAN},
    {"TKAU-TKAU", "ほほえ", 'm', VERB_TYPE_GODAN},
    {"YA-SU", "やす", 'm', VERB_TYPE_GODAN},
    {"I-", "い", 'r', VERB_TYPE_GODAN},
    {"KA-KNI", "かぎ", 'r', VERB_TYPE_GODAN},
    {"KNA-TKNA", "がんば", 'r', VERB_TYPE_GODAN},
    {"KNA-", "がんば", 'r', VERB_TYPE_GODAN},
    {"KIA-", "け", 'r', VERB_TYPE_GODAN},
    {"SYA-TKNIA", "しゃべ", 'r', VERB_TYPE_GODAN},
    {"SU-TKNIA", "すべ", 'r', VERB_TYPE_GODAN},
    {"T-KA", "たすか", 'r', VERB_TYPE_GODAN},
    {"NA-", "な", 'r', VERB_TYPE_GODAN},
    {"TKY-", "はい", 'r', VERB_TYPE_GODAN},
    {"TKA-TKNA", "はばか", 'r', VERB_TYPE_GODAN},
    {"YA-", "や", 'r', VERB_TYPE_GODAN},
    {"-YA", "や", 'r', VERB_TYPE_GODAN},
    {"SKA-", "わか", 'r', VERB_TYPE_GODAN},
    {"-A", "あ", 'w', VERB_TYPE_GODAN},
    {"A-STA", "あら", 'w', VERB_TYPE_GODAN},
    {"A-SAU", "あらそ", 'w', VERB_TYPE_GODAN},
    {"IU-", "い", 'w', VERB_TYPE_GODAN},
    {"I-SNA", "いざな", 'w', VERB_TYPE_GODAN},
    {"I-SKA", "いわ", 'w', VERB_TYPE_GODAN},
    {"U-SI", "うしな", 'w', VERB_TYPE_GODAN},
    {"U-TA", "うた", 'w', VERB_TYPE_GODAN},
    {"U-KNA", "うたが", 'w', VERB_TYPE_GODAN},
    {"U-YA", "うやま", 'w', VERB_TYPE_GODAN},
    {"AU-SKNAU", "おも", 'w', VERB_TYPE_GODAN},
    {"AU-", "おも", 'w', VERB_TYPE_GODAN},
    {"KA-NA", "かな", 'w', VERB_TYPE_GODAN},
    {"KA-SKNA", "かま", 'w', VERB_TYPE_GODAN},
    {"KU-STU", "くる", 'w', VERB_TYPE_GODAN},
    {"SI-A", "しあ", 'w', VERB_TYPE_GODAN},
    {"SI-TA", "したが", 'w', VERB_TYPE_GODAN},
    {"SI-SKNA", "しま", 'w', VERB_TYPE_GODAN},
    {"SAU-STAU", "そろ", 'w', VERB_TYPE_GODAN},
    {"TA-TA", "たたか", 'w', VERB_TYPE_GODAN},
    {"TI-KA", "ちか", 'w', VERB_TYPE_GODAN},
    {"TI-KNA", "ちが", 'w', VERB_TYPE_GODAN},
    {"TU-KA", "つか", 'w', VERB_TYPE_GODAN},
    {"TU-TI", "つちか", 'w', VERB_TYPE_GODAN},
    {"TU-TNAU", "つど", 'w', VERB_TYPE_GODAN},
    {"TIA-STA", "てら", 'w', VERB_TYPE_GODAN},
    {"TNIA-A", "であ", 'w', VERB_TYPE_GODAN},
    {"TAU-NA", "ともな", 'w', VERB_TYPE_GODAN},
    {"NA-STA", "なら", 'w', VERB_TYPE_GODAN},
    {"NI-A", "にあ", 'w', VERB_TYPE_GODAN},
    {"NI-SKA", "にぎわ", 'w', VERB_TYPE_GODAN},
    {"NIA-KNA", "ねが", 'w', VERB_TYPE_GODAN},
    {"NAU-STAU", "のろ", 'w', VERB_TYPE_GODAN},
    {"TKA-STA", "はら", 'w', VERB_TYPE_GODAN},
    {"TKI-STAU", "ひろ", 'w', VERB_TYPE_GODAN},
    {"SKNA-TAU", "まと", 'w', VERB_TYPE_GODAN},
    {"SKNI-A", "みあ", 'w', VERB_TYPE_GODAN},
    {"SKNU-KA", "むか", 'w', VERB_TYPE_GODAN},
    {"SKNAU-STA", "もら", 'w', VERB_TYPE_GODAN},
    {"SKA-STA", "わら", 'w', VERB_TYPE_GODAN},
    {"TN-KI", "で", 'k', VERB_TYPE_KAMI},
    {"IA-SNI", "えん", 'z', VERB_TYPE_KAMI},
    {"KA-SNI", "かん", 'z', VERB_TYPE_KAMI},
    {"KI-SNI", "きん", 'z', VERB_TYPE_KAMI},
    {"SI-SNI", "しん", 'z', VERB_TYPE_KAMI},
    {"TNA-SNI", "だん", 'z', VERB_TYPE_KAMI},
    {"KA-SKNI", "かんが", 'm', VERB_TYPE_KAMI},
    {"T-KIA", "たす", 'k', VERB_TYPE_SIMO},
    {"TU-TN", "つづ", 'k', VERB_TYPE_SIMO},
    {"TN-KIA", "つづ", 'k', VERB_TYPE_SIMO},
    {"K-KNIA", "かか", 'g', VERB_TYPE_SIMO},
    {"SKNA-KA", "まか", 's', VERB_TYPE_SIMO},
    {"KU-STA", "くら", 'b', VERB_TYPE_SIMO},
    {"SA-TNA", "さだ", 'm', VERB_TYPE_SIMO},
    {"TKA-SNI", "はじ", 'm', VERB_TYPE_SIMO},
    {"SKNAU-TAU", "もと", 'm', VERB_TYPE_SIMO},
    {"KAU-STIA", "こわ", 'r', VERB_TYPE_SIMO},
    {"SKA-SU", "わす", 'r', VERB_TYPE_SIMO},
    {"AU-SA", "おさ", 'w', VERB_TYPE_SIMO},
    {"AU-TKNAU", "おぼ", 'w', VERB_TYPE_SIMO},
    {"KA-KNA", "かんが", 'w', VERB_TYPE_SIMO},
    {"KA-", "かんが", 'w', VERB_TYPE_SIMO},
    {"KU-SKA", "くわ", 'w', VERB_TYPE_SIMO},
    {"KAU-TA", "こた", 'w', VERB_TYPE_SIMO},
    {"SA-SA", "ささ", 'w', VERB_TYPE_SIMO},
    {"SKNA-KNA", "まちが", 'w', VERB_TYPE_SIMO},
    {"KI-KNA", "きがつ", 'k', VERB_TYPE_GODAN},
    {"TU-TNU", "つづ", 'k', VERB_TYPE_GODAN},
    {"SA-KNA", "さが", 's', VERB_TYPE_GODAN},
    {"TNA-", "だ", 's', VERB_TYPE_GODAN},
    {"SKNI-TA", "みた", 's', VERB_TYPE_GODAN},
    {"SKNI-SKNA", "みまわ", 's', VERB_TYPE_GODAN},
    {"SKNI-SKA", "みわた", 's', VERB_TYPE_GODAN},
    {"KU-TNA", "くださ", 'r', VERB_TYPE_GODAN},
    {"TA-SNU", "たずさわ", 'r', VERB_TYPE_GODAN},
    {"AU-KAU", "おこな", 'w', VERB_TYPE_GODAN},
    {"KI-SKAU", "きをつ", 'k', VERB_TYPE_SIMO},
    {"TA-SI", "たしか", 'm', VERB_TYPE_SIMO},
    {"NA-KNA", "なが", 'r', VERB_TYPE_SIMO},
    {"AU-SI", "おし", 'w', VERB_TYPE_SIMO},
};
...
static const mj_cmd_t mejiro_commands_zmk[] = {
    ...
    {"Sk#-",   MJ_CMD_MOD_KEY,  MJ_KC(HID_USAGE_KEY_KEYBOARD_Z), MJ_KC_LCTRL, 0, NULL},
    {"Kk#-",   MJ_CMD_MOD_KEY,  MJ_KC(HID_USAGE_KEY_KEYBOARD_X), MJ_KC_LCTRL, 0, NULL},
    {"Nk#-",   MJ_CMD_MOD_KEY,  MJ_KC(HID_USAGE_KEY_KEYBOARD_C), MJ_KC_LCTRL, 0, NULL},
    {"Ak#-",   MJ_CMD_MOD_KEY,  MJ_KC(HID_USAGE_KEY_KEYBOARD_V), MJ_KC_LCTRL, 0, NULL},
    {"Ank#-",  MJ_CMD_MOD2_KEY, MJ_KC(HID_USAGE_KEY_KEYBOARD_V), MJ_KC_LCTRL, MJ_KC_LSFT, NULL},
    ...
    {"-NYA",   MJ_CMD_STRING,   0, 0, 0, "zhj"},
    {"-TNY",   MJ_CMD_STRING,   0, 0, 0, "zlk"},
    {"-NYI",   MJ_CMD_STRING,   0, 0, 0, "zhk"},
    {"-KNY",   MJ_CMD_STRING,   0, 0, 0, "zlj"},
    ...
    for (size_t i = 0; i < ARRAY_SIZE(mejiro_commands_zmk); i++) {
        ...
        case MJ_CMD_REPEAT:
            if (g_mejiro_last_output[0] != '\0') {
                send_mejiro_roma(g_mejiro_last_output);
                mejiro_history_push(g_mejiro_last_units > 0 ? g_mejiro_last_units
                                                           : (uint16_t)strlen(g_mejiro_last_output));
            }
            return true;
        ...
        case MJ_CMD_KEY:
            ...
            if (mejiro_commands_zmk[i].keycode == MJ_KC(HID_USAGE_KEY_KEYBOARD_DELETE_BACKSPACE) ||
                mejiro_commands_zmk[i].keycode == MJ_KC(HID_USAGE_KEY_KEYBOARD_DELETE_FORWARD)) {
                mejiro_clear_pending_tsu_zmk();
            }
            return true;

        case MJ_CMD_MOD_KEY:
            press_key(mejiro_commands_zmk[i].mod);
            tap_key(mejiro_commands_zmk[i].keycode);
            release_key(mejiro_commands_zmk[i].mod);
            return true;

        case MJ_CMD_MOD2_KEY:
            press_key(mejiro_commands_zmk[i].mod);
            press_key(mejiro_commands_zmk[i].mod2);
            tap_key(mejiro_commands_zmk[i].keycode);
            release_key(mejiro_commands_zmk[i].mod2);
            release_key(mejiro_commands_zmk[i].mod);
            return true;

        case MJ_CMD_STRING:
            send_mejiro_command_string(mejiro_commands_zmk[i].string);
            return true;
...
static void send_ascii_letters_only(const char *s) {
    for (const char *p = s; *p; p++) {
        ...
        /* Keep debug visibility for stroke symbols too (#, *, -). */
        if (c == '#' || c == '*' || c == '-') {
            switch (c) {
...
mejiro_result_t_zmk mejiro_transform_zmk(const char *mejiro_id) {
    ...
    if (has_asterisk) {
        ...
        // 失敗時は * を無視した通常経路へフォールバック
        char starless_id[128] = {0};
        size_t j = 0;
        for (size_t i = 0; mejiro_id[i] != '\0' && j < sizeof(starless_id) - 1; i++) {
            if (mejiro_id[i] != '*') {
                starless_id[j++] = mejiro_id[i];
            }
        }
        starless_id[j] = '\0';
        if (strcmp(starless_id, mejiro_id) != 0) {
            return mejiro_transform_zmk(starless_id);
        }
    }
...
static void send_mejiro_output(const char *mejiro_id) {
    ...
    mejiro_result_t_zmk result = mejiro_transform_zmk(mejiro_id);
    if (!result.success) {
        if (strchr(mejiro_id, '*') != NULL) {
            send_mejiro_roma("rawstar:");
            send_mejiro_roma(mejiro_id);
        }
        /* Undefined stroke: emit nothing. Keep state cleanup at caller side only. */
        return;
    }
    ...
    strncpy(g_mejiro_last_output, result.output, sizeof(g_mejiro_last_output) - 1);
    g_mejiro_last_output[sizeof(g_mejiro_last_output) - 1] = '\0';

    g_mejiro_last_units =
        (uint16_t)(result.kana_length > 0 ? result.kana_length : strlen(result.output));
    mejiro_history_push(g_mejiro_last_units);
}
